...
const DashBoard = () => {
    ...
    const [dashboardData, setDashboasrdDate] = useState({
        totalBookings: 0,
        totalRevenue: 0,
        activeShows: [],
        totalUser: 0
    ...
    const dashboardCards = [
        { title: "Total Bookings", value: currency + dashboardData.totalBookings || "0", icon: ChartLineIcon },
    ...
    const fetchDashboardData = async () => {
        setDashboasrdDate(dummyDashboardData)
        setLoading(false)
    }
